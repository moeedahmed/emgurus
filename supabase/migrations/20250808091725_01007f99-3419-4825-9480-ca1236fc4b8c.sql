-- Unified taxonomy migration (full, idempotent)
...
ALTER TABLE IF EXISTS public.taxonomy_post_terms ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.taxonomy_question_terms ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.taxonomy_thread_terms ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.taxonomy_profile_terms ENABLE ROW LEVEL SECURITY;
...
-- 5) Seed initial terms (idempotent & typed)
