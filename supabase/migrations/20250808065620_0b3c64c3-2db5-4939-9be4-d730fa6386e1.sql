-- Robust status type migration with reviewer_id present
...
-- 2) Ensure reviewer_id column exists before policy creation
DO $$ BEGIN
  IF NOT EXISTS (
...
-- 3) Drop old policies that may reference status
