...
const Quiz = () => {
  ...
  const handleStartQuiz = (type: 'realtime' | 'reviewed') => {
    setSelectedOption(type);
    // TODO: Navigate to actual quiz based on type
    console.log(`Starting ${type} quiz`);
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="p-8 hover:shadow-strong transition-all duration-300 hover:scale-105 cursor-pointer border-2 hover:border-primary">
              ...
              <Button 
                className="w-full"
                variant="default"
                onClick={() => handleStartQuiz('realtime')}
              >
                Start AI Questions
              </Button>
            </Card>
            ...
            <Card className="p-8 hover:shadow-strong transition-all duration-300 hover:scale-105 cursor-pointer border-2 hover:border-primary">
              ...
              <Button 
                className="w-full"
                variant="hero"
                onClick={() => handleStartQuiz('reviewed')}
              >
                Start Reviewed Questions
              </Button>
            </Card>
          </div>
