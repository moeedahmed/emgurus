...
export default function BlogGenerator() {
  ...
  return (
    <div className="p-4 max-w-4xl">
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-1">AI Blog Generator</h2>
        <p className="text-sm text-muted-foreground">Generate AI-powered blog drafts and assign them to Gurus for review.</p>
      </div>
